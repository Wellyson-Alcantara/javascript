...
// Todas as variáveis declaradas aqui em cima - fora das funções - são consideradas GLOBAIS e funcionam dentro e fora de qualquer outra função!
...
function jogar() {
    ...
    if (jogador < computador) {
        ...
        document.getElementById('botao').style.visibility = 'hidden' // O comnado depoi de ('botao), serve para deixar o button invisivel depois que o resultado é encontrado!
    }
}